...
public class BoxLayoutContext extends AbstractLayoutAlgorithmContext implements TunableValidator {
	
	public BoxLayoutContext(boolean supportsSelectedOnly, Set<Class<?>> supportedNodeAttributes, Set<Class<?>> supportedEdgeAttributes) {
