 ...
 */
public class WindMapRenderingEngine implements RenderingEngine<CyNetwork> {
	...
	public static void setNetworkViewManager(CyNetworkViewManager
			networkViewManager) {
		WindMapRenderingEngine.networkViewManager = networkViewManager;
	}
	...
	private Graphics newInstance(CyNetworkView networkView, VisualLexicon visualLexicon) {
		return new Graphics(networkView, visualLexicon, new BirdsEyeGraphics());
	}
